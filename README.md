...
| Extended   | $14/user/mo    | Unlimited | Multiple AI bots, Autofix, PR mode (GitLab/GitHub/Gitea/Forgejo/Bitbucket/Bitbucket Server/Azure DevOps/Gerrit), LDAP/AD, Audit log, Prometheus metrics |
